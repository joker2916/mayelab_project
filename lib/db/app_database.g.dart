...
class $AdminConfigTable extends AdminConfig
    with TableInfo<$AdminConfigTable, AdminConfigData> {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  $AdminConfigTable(this.attachedDatabase, [this._alias]);
  static const VerificationMeta _idMeta = const VerificationMeta('id');
  @override
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
      'id', aliasedName, false,
  ...
  @override
  List<GeneratedColumn> get $columns =>
      [id, pinHash, salt, createdAt, updatedAt];
  @override
  String get aliasedName => _alias ?? actualTableName;
  @override
  String get actualTableName => $name;
  static const String $name = 'admin_config';
  @override
  VerificationContext validateIntegrity(Insertable<AdminConfigData> instance,
      {bool isInserting = false}) {
    final context = VerificationContext();
    final data = instance.toColumns(true);
    if (data.containsKey('id')) {
  ...
  Set<GeneratedColumn> get $primaryKey => {id};
  @override
  AdminConfigData map(Map<String, dynamic> data, {String? tablePrefix}) {
    final effectivePrefix = tablePrefix != null ? '$tablePrefix.' : '';
  ...
  @override
  $AdminConfigTable createAlias(String alias) {
    return $AdminConfigTable(attachedDatabase, alias);
  }
}

class AdminConfigData extends DataClass implements Insertable<AdminConfigData> {
  final String id;
  ...
  AdminConfigCompanion toCompanion(bool nullToAbsent) {
    return AdminConfigCompanion(
      id: Value(id),
  ...
  AdminConfigData copyWithCompanion(AdminConfigCompanion data) {
    return AdminConfigData(
      id: data.id.present ? data.id.value : this.id,
  ...
  @override
  String toString() {
    return (StringBuffer('AdminConfigData(')
          ..write('id: $id, ')
  ...
  @override
  int get hashCode => Object.hash(id, pinHash, salt, createdAt, updatedAt);
  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      (other is AdminConfigData &&
          other.id == this.id &&
...
class AdminConfigCompanion extends UpdateCompanion<AdminConfigData> {
  final Value<String> id;
  ...
  AdminConfigCompanion.insert({
    ...
    this.rowid = const Value.absent(),
        ...
        salt = Value(salt);
  static Insertable<AdminConfigData> custom({
    Expression<String>? id,
  ...
  @override
  String toString() {
    return (StringBuffer('AdminConfigCompanion(')
          ..write('id: $id, ')
          ..write('pinHash: $pinHash, ')
          ..write('salt: $salt, ')
          ..write('createdAt: $createdAt, ')
...
abstract class _$AppDatabase extends GeneratedDatabase {
  ...
  late final $AdminConfigTable adminConfig = $AdminConfigTable(this);
...
typedef $$TauxChangeTableProcessedTableManager = ProcessedTableManager<
    ...
    TauxChangeData,
    PrefetchHooks Function()>;
typedef $$AdminConfigTableCreateCompanionBuilder = AdminConfigCompanion
    Function({
  Value<String> id,
  required String pinHash,
  required String salt,
...
typedef $$AdminConfigTableUpdateCompanionBuilder = AdminConfigCompanion
    Function({
  Value<String> id,
  Value<String> pinHash,
  Value<String> salt,
...
class $$AdminConfigTableFilterComposer
    extends Composer<_$AppDatabase, $AdminConfigTable> {
  $$AdminConfigTableFilterComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AdminConfigTableOrderingComposer
    extends Composer<_$AppDatabase, $AdminConfigTable> {
  $$AdminConfigTableOrderingComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AdminConfigTableAnnotationComposer
    extends Composer<_$AppDatabase, $AdminConfigTable> {
  $$AdminConfigTableAnnotationComposer({
    required super.$db,
    required super.$table,
    super.joinBuilder,
    super.$addJoinBuilderToRootComposer,
...
class $$AdminConfigTableTableManager extends RootTableManager<
    _$AppDatabase,
    $AdminConfigTable,
    AdminConfigData,
    $$AdminConfigTableFilterComposer,
    $$AdminConfigTableOrderingComposer,
    $$AdminConfigTableAnnotationComposer,
    $$AdminConfigTableCreateCompanionBuilder,
    $$AdminConfigTableUpdateCompanionBuilder,
    (
      AdminConfigData,
      BaseReferences<_$AppDatabase, $AdminConfigTable, AdminConfigData>
    ),
    AdminConfigData,
    PrefetchHooks Function()> {
  $$AdminConfigTableTableManager(_$AppDatabase db, $AdminConfigTable table)
      : super(TableManagerState(
          db: db,
          table: table,
          createFilteringComposer: () =>
              $$AdminConfigTableFilterComposer($db: db, $table: table),
          createOrderingComposer: () =>
              $$AdminConfigTableOrderingComposer($db: db, $table: table),
          createComputedFieldComposer: () =>
              $$AdminConfigTableAnnotationComposer($db: db, $table: table),
          updateCompanionCallback: ({
            Value<String> id = const Value.absent(),
...
typedef $$AdminConfigTableProcessedTableManager = ProcessedTableManager<
    _$AppDatabase,
    $AdminConfigTable,
    AdminConfigData,
    $$AdminConfigTableFilterComposer,
...
class $AppDatabaseManager {
  ...
  $$AdminConfigTableTableManager get adminConfig =>
      $$AdminConfigTableTableManager(_db, _db.adminConfig);
}
